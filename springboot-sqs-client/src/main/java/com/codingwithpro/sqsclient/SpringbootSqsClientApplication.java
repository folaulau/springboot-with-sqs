package com.codingwithpro.sqsclient;
...
public class SpringbootSqsClientApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(SpringbootSqsClientApplication.class, args);
	}
